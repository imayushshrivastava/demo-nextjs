            ...
            <div className="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.6s">
                <div className="testimonial-item bg-light my-4">
                    <div className="d-flex align-items-center border-bottom pt-5 pb-4 px-5">
                        <Image className="img-fluid rounded" src="/img/testimonial-1.jpg" alt="" width={60} height={60} />
                        <div className="ps-4">
                ...
                <div className="testimonial-item bg-light my-4">
                    <div className="d-flex align-items-center border-bottom pt-5 pb-4 px-5">
                        <Image className="img-fluid rounded" src="/img/testimonial-2.jpg" alt="" width={60} height={60} />
                        <div className="ps-4">
                            <h4 className="text-primary mb-1">Client Name</h4>
                            <small className="text-uppercase">Profession</small>
                        </div>
                ...
                <div className="testimonial-item bg-light my-4">
                    <div className="d-flex align-items-center border-bottom pt-5 pb-4 px-5">
                        <Image className="img-fluid rounded" src="/img/testimonial-3.jpg" alt="" width={60} height={60} />
                        <div className="ps-4">
                            <h4 className="text-primary mb-1">Client Name</h4>
                            <small className="text-uppercase">Profession</small>
                        </div>
                ...
                <div className="testimonial-item bg-light my-4">
                    <div className="d-flex align-items-center border-bottom pt-5 pb-4 px-5">
                        <Image className="img-fluid rounded" src="/img/testimonial-4.jpg" alt="" width={60} height={60} />
                        <div className="ps-4">
                            <h4 className="text-primary mb-1">Client Name</h4>
                            <small className="text-uppercase">Profession</small>
                        </div>
